...
<header id="header" class="header fixed-top d-flex align-items-center">
  <div class="d-flex align-items-center justify-content-between">
    <a href="<?= base_url('validators/dashboard') ?>" class="logo d-flex align-items-center">
...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?= base_url('validators/dashboard') ?>">
    ...
    <li class="nav-item">
      ...
      <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="<?= base_url('validators/onholdticket') ?>">
            <i class="bi bi-circle"></i><span>On Hold</span>
          </a>
        </li>
        <li>
          <a href="<?= base_url('validators/otoritizedticket') ?>">
            <i class="bi bi-circle"></i><span>Authorized</span>
          </a>
        </li>
        <li>
          <a href="<?= base_url('validators/rejectedticket') ?>">
